...
Traveler.destroy_all
    ...
    url = URI("https://hotels4.p.rapidapi.com/properties/list?adults1=1&pageNumber=1&destinationId=1506246&pageSize=9&checkOut=2021-07-01&checkIn=2021-07-10&starRatings=5&sortOrder=PRICE&locale=en_US&currency=USD")
    ...
    hotels= JSON.parse(response.read_body)["data"]["body"]["searchResults"]["results"]
     ...
     url = URI("https://hotels4.p.rapidapi.com/properties/list?adults1=1&pageNumber=1&destinationId=1535616&pageSize=9&checkOut=2021-07-01&checkIn=2021-07-10&starRatings=3%2C4&sortOrder=PRICE&locale=en_US&currency=USD")
...
url = URI("https://hotels4.p.rapidapi.com/properties/list?adults1=1&pageNumber=1&destinationId=1661225&pageSize=6&checkOut=2021-07-10&checkIn=2021-07-15&starRatings=5&sortOrder=PRICE&locale=en_US&currency=USD")
    ...
    hotels= JSON.parse(response.read_body)["data"]["body"]["searchResults"]["results"]
     ...
     url = URI("https://hotels4.p.rapidapi.com/properties/list?adults1=1&pageNumber=1&destinationId=1661225&pageSize=15&checkOut=2021-07-10&checkIn=2021-07-01&starRatings=3%2C4&sortOrder=STAR_RATING_HIGHEST_FIRST&locale=en_US&currency=USD")
    ...
    url = URI("https://hotels4.p.rapidapi.com/properties/list?adults1=1&pageNumber=1&destinationId=1405364&pageSize=12&checkOut=2021-07-21&checkIn=2021-07-15&starRatings=5&sortOrder=PRICE&locale=en_US&currency=USD")
    ...
    hotels= JSON.parse(response.read_body)["data"]["body"]["searchResults"]["results"]
     ...
     url = URI("https://hotels4.p.rapidapi.com/properties/list?adults1=1&pageNumber=1&destinationId=1405364&pageSize=12&checkOut=2021-07-21&checkIn=2021-07-15&starRatings=3%2C4&sortOrder=STAR_RATING_HIGHEST_FIRST&locale=en_US&currency=USD")
    ...
    hotels= JSON.parse(response.read_body)["data"]["body"]["searchResults"]["results"]
     ...
     url = URI("https://hotels4.p.rapidapi.com/properties/list?adults1=1&pageNumber=1&destinationId=1481165&pageSize=9&checkOut=2021-07-10&checkIn=2021-07-01&starRatings=3%2C4&sortOrder=PRICE&locale=en_US&currency=USD")
    ...
    response = http.request(request)
     ...
     url = URI("https://hotels4.p.rapidapi.com/properties/list?adults1=1&pageNumber=1&destinationId=1520387&pageSize=12&checkOut=2021-07-10&checkIn=2021-07-01&starRatings=4%2C3&sortOrder=STAR_RATING_HIGHEST_FIRST&locale=en_US&currency=USD")
...
Tour3 = Tour.create(name: "Washington Monument", description: "The Washington Monument is an obelisk within the National Mall in Washington, D.C., built to commemorate George Washington", timage: "https://d1dzqwexhp5ztx.cloudfront.net/timageRepo/7/0/113/310/593/S_Washington_Monument_S.jpg", location: "Washington Dc", tprice: 6.99,  video: 'https://www.youtube.com/embed/EAt8vA6UpNE')
...
Tour6 = Tour.create(name: "Fort Tryon Park", description: "Fort Tryon Park is a public park located in the Hudson Heights and Inwood neighborhoods of the borough of Manhattan in New York City. The 67-acre park is situated on a ridge in Upper Manhattan, close to the Hudson River to the west", timage: "https://3evlzmko7591que7cpvox4ta-wpengine.netdna-ssl.com/wp-content/uploads/2020/09/Fort-Tryon-Park-NYC-copyright-Byelikova-Dreamstime-1600x800-1.jpg", location: "New York", tprice: 6.99,  video: 'https://www.youtube.com/embed/L6YclBK6lH0' )
...
Tour10 = Tour.create(name: "White House", description: "Obviously, the White House ranks high as one of the top Washington DC landmarks you’ve got to see during your trip.", timage: "https://ctycms.com/dc-capitol-riverfront/timages/ypt1-dancing-fountains.jpg", location: "Washington Dc", tprice: 7.99, video: 'https://www.youtube.com/embed/U1JCy5rU_3s')
...
Tour12 = Tour.create(name: "United States Capitol", description: "Serving as the home of the Senate and House of Representatives, the U.S. Capitol building is not only architecturally impressive but a symbol of American democracy the world over.", timage: "https://content.tripster.com/travelguide/wp-content/uploads/2019/07/United_States_Capitol_west_front_edit2.jpg", location: "Washington Dc", tprice: 7.99, video: 'https://www.youtube.com/embed/qvgq1awXNzs')
